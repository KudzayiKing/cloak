...
/*
 * EllipsisVerticalIcon (owner-supplied reference component) — the three
 * vertical dots that anchor the mobile overflow menu. Each dot does a
 * short staggered slide while hovered with a fine pointer (web); mobile
 * presses get the standard touch feedback from the wrapping button.
 * prefers-reduced-motion collapses the wiggle to the rest state.
 */
